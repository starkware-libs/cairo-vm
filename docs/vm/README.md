<!-- This documentation was taken from the https://github.com/starkware-libs/cairo-vm_in_go repository -->
...
- Take a compiled cairo program as input. You can check out an example program [here](https://github.com/starkware-libs/cairo-vm.go/blob/main/cairo_programs/fibonacci.cairo).
...
If you want a step by step guide on how to implement your own VM you can read our [code walkthrough in Go](https://github.com/starkware-libs/cairo-vm_in_go?tab=readme-ov-file#code-walkthroughwrite-your-own-cairo-vm)
